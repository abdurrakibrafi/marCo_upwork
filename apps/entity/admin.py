...
class EntityAdmin(admin.ModelAdmin):
    """Admin interface configuration for Entity model."""
...
class TeamAdmin(admin.ModelAdmin):
    """Admin interface configuration for Team model details."""
...
class AthleteAdmin(admin.ModelAdmin):
    """Admin interface configuration for Athlete model details."""
...
class LeagueAdmin(admin.ModelAdmin):
    """Admin interface configuration for League model details."""
...
class EntityStatsAdmin(admin.ModelAdmin):
    """Admin interface configuration for EntityStats cache model."""
